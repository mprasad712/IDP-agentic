...
class idpSettings:
  ...
  def __init__(self):
    #all the base paths  
    BACKEND_BASE_PATH = "/data/digital_workmate_agentic/extraction_app" #path till idp_solution FOLDER
    FRONTENT_BASE_PATH = "/data/digital_workmate_agentic/web_app/backend_web" #PATH TILL IDP FOLDER
