    ...
    <div className="min-h-screen flex bg-pwc-navy">
      ...
      <div className="hidden lg:flex lg:w-[55%] flex-col relative overflow-hidden">
        ...
        <div className="relative flex flex-col h-full px-14 py-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-semibold text-sm tracking-wide">PwC Technology Consulting</p>
              <p className="text-pwc-gray-cool text-xs">Document Intelligence Platform</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 bg-pwc-surface relative">
        ...
        <div className="lg:hidden absolute top-8 left-6 flex items-center gap-2">
          ...
          <span className="text-pwc-navy font-semibold text-sm">IDP Platform</span>
        </div>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mt-6 rounded-lg border border-pwc-surface-dark bg-white px-4 py-3">
          ...
          {/* Footer */}
          <p className="mt-8 text-center text-xs text-pwc-gray-cool">
            © {new Date().getFullYear()} PwC Technology Consulting · Document Intelligence Platform
          </p>
        </div>
      </div>
    </div>
